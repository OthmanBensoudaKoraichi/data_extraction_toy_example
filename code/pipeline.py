    ...
    async def ask_defendants(state: State) -> State:
        ...
        res = await defendants_chain.ainvoke({
            ...
            "question": (
                ...
                "in this document. Look for first-person past-tense language from a process "
                "server: 'I personally delivered', 'I left the documents listed in item 2 with', "
                "'by substituted service', etc.\n\n"
                "Look specifically at item 5 of each POS-010 form — this is where the "
                "service method is recorded with checkboxes (personal service, substituted "
                "service, etc.) along with the date and time.\n\n"
                ...
                "IMPORTANT: If the defendant's name or address is redacted, blacked out, "
                "or appears as a blank/figure placeholder, still extract the defendant — "
                "use 'REDACTED' as the name and/or address. The service details (method, "
                "date, time) are what matter, not the name.\n\n"
                "EXCLUDE the following — these are NOT completed service:\n"
                "- Defendants merely listed in the case caption or complaint header\n"
                "- 'APPLICATION AND ORDER TO SERVE SUMMONS BY POSTING' (LACIV 107 form) — "
                "this is a request to the court, not a record of completed service. "
                "Return 0 defendants for these.\n\n"
